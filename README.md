...
git clone https://github.com/oscarsanchez0712/Cloudcontactos.git
cd Cloudcontactos
python3 -m venv venv
...
- **Formulario:** http://44.196.213.222
- **Lista de contactos:** http://44.196.213.222/contacts

## 👨‍💻 Autor

**Oscar Heyton Sanchez Arias**
I.E.S.T.P. Valle Grande - Análisis de Sistemas
